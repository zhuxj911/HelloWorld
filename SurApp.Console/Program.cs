    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			*/
            ...
            Point[] pts = new Point[] {new Point(4,0), new Point(5,0), new Point(6,0) };
            pl.AddRange(pts);

            shapes.Add(pl);

            Polyline pl2 = new Polyline();//长度21.494848364936182
            pl2.Add(new Point(-1, 0));
            pl2.Add(new Point(2, 3));
            pl2.Add(new Point(4, 2));

            pts = new Point[] { new Point(4, 4), new Point(6, 8), new Point(-2, 5) };
            pl2.AddRange(pts);
            ...
            pg.Add(new Point(1, 0));
            pg.Add(new Point(2, 0));
            pg.Add(new Point(3, 0));

            pts = new Point[] { new Point(4, 0), new Point(5, 0), new Point(6, 0) };
            pg.AddRange(pts);

            shapes.Add(pg);

            Polygon pg2 = new Polygon(); //面积28， 长度26.593867878528968           
            pg2.AddRange(new Point[] {
                new Point(-1, 0),
                new Point(2, 3),
                new Point(4, 2),
                new Point(4, 4),
