...
namespace ProjApp
{
    public class DrawingCanvas : System.Windows.Controls.Canvas
    {
        ...
        private void OnDraw(ObservableCollection<GPoint> SPointList)
        {
        ...
        private void GetGaussXySize(ObservableCollection<GPoint> SPointList)
        {
        ...
        {
            base.OnRender(dc);
            ObservableCollection<GPoint> SPointList = this.Tag as ObservableCollection<GPoint>;
